...
def txt_to_docx(txt_path, docx_path, book_title, chapter_pattern):
    ...
    Args: D:\Light Novel\Magic Warrior White・Love!\Truyện Cao H\New folder\TranslateNovelAI\TranlateNovelAI\novel\Tứ hợp viện chi ba ba thành thủ phủ (1-1020 chương)_TranslateAI.txt
